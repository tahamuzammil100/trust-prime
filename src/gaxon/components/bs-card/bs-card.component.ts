...
export class BsCardComponent implements OnInit, AfterViewInit {
  @ContentChild(CardHeaderComponent, {static: false}) cardHeader;
  @ContentChild(CardImgOverlayComponent, {static: false}) cardImgOverlay;
  @ContentChild(CardBodyComponent, {static: false}) cardBody;
  @ContentChild(CardOuterBodyComponent, {static: false}) cardOuterBody;
  @ContentChild(CardFooterComponent, {static: false}) cardFooter;
