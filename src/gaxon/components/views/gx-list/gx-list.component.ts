...
export class GxListComponent implements OnInit {
  @ContentChild(GxListHeaderComponent, {static: false}) listHeader;
  @ContentChild(GxListFooterComponent, {static: false}) listFooter;
  @ContentChild(GxSliderComponent, {static: false}) slider;
