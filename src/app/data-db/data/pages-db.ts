export class PagesDb {
    ...
    public static wallPagePosts = [
        {
            id: 1,
            user_name: 'Kayli Brown',
            user_image: 'https://via.placeholder.com/150X150',
            message: '',
            attachments: [
                {name: 'Sunset', image: 'https://via.placeholder.com/640X420'},
                {name: 'Beach', image: 'https://via.placeholder.com/640X420'},
                {name: 'Water Skating', image: 'https://via.placeholder.com/640X420'},
                {name: 'Walking', image: 'https://via.placeholder.com/640X420'}
            ],
            created_at: new Date().setMinutes(new Date().getMinutes() - 15),
            feeds: {
                views: 2000,
                likes: 120,
                comments: 29
